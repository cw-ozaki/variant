...
smoke22: build
	cd $(IT_DIR) && export PATH=$(shell pwd)/dist/$(VERSION):$$PATH && ./containerized-task-env autoenv --logtostderr | grep "FOO=input" && ./containerized-task-env noautoenv --logtostderr | grep "FOO=" && echo smoke16 passed.
